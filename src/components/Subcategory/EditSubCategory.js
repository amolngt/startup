...
const EditSubCategory =()=>{
  ...
  const history= useHistory()
    ...
    useEffect(()=>{
      axios.get(constants.LOCAL+"subcategory/"+id).then(response=>{
        setSubCategory({
    ...
    const onSubmit=(e)=>{
        e.preventDefault();
        axios.post(constants.LOCAL+'subcategory/update/'+id,subcategory).then(response=>{
    ...
    return(
      <div className="main">
        ...
        <h4 className="post_heading">Edit SubCategory</h4>
